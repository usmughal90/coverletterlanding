...
export default function DownloadSection() {
  return (
    <section id="download" className="bg-[#059669] overflow-visible pt-28">
          ...
          <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-12">
            ...
            <div className="order-2 text-center lg:order-1 lg:col-span-6 lg:text-left">
              <h2 className="text-balance text-2xl font-extrabold leading-tight sm:text-4xl">
                Let's download free from Apple Store
                {/* <br className="hidden sm:block" />  */}
              </h2>
              <p className="mt-4 mx-auto lg:mx-0 max-w-xl text-pretty text-base leading-6 text-[#ffffff] lg:max-w-none">
                Create job-winning resumes and AI-powered cover letters in
                minutes. Land interviews faster and stand out from the crowd.
              </p>
            ...
            {/* Right images */}
            <div className="order-1 relative flex items-center justify-center lg:order-2 lg:col-span-6 lg:justify-end">
              <div className="relative h-[260px] w-full max-w-[420px] sm:h-[300px]">
                <div className="absolute bottom-0 right-1/2 translate-x-1/2 lg:right-0 lg:translate-x-0 w-[140px] sm:w-[180px]">
                  <Image
                    src="/images/slides/cover-letter-ai-img-8.png"
