      ...
      <div className="mx-auto max-w-6xl px-6 py-16 sm:py-18">
        ...
        <div className="mt-12 grid grid-cols-1 gap-8 md:grid-cols-2">
          {features.map((f) => (
            <div
              key={f.title}
              className="group rounded-2xl border border-[#059669] bg-[#ffffff] px-7 py-7 shadow-[0_8px_30px_rgba(16,24,40,0.06)]  hover:shadow-xl transition-all transform hover:scale-103 active:scale-95"
            >
              <div className="flex items-start gap-5">
                <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-[#02a3301d]    ">
                  <img
                    src={f.iconSrc}
                    alt={f.iconAlt}
                    className="h-6 w-6"
