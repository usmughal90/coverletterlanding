  ...
  return (
    <>
      {posts.data && posts?.data.length > 0 ? (
        <section className="w-full bg-[#F9FAFB] " id="blog">
          <div className="mx-auto max-w-6xl px-6 py-16 sm:py-20 ">
            ...
            <div className="flex justify-center">
              <button className="mt-8 text-sm font-bold bg-[#059669]   text-white px-4 py-2 rounded-md cursor-pointer transition-all shadow-lg transform hover:scale-102 active:scale-95">
