export default function Footer() {
  return (
    <footer className="bg-[#059669] px-6 md:px-16 py-8 text-center text-xs text-[#ffffff] border-t border-white/10 flex flex-col  items-center justify-between gap-4">
